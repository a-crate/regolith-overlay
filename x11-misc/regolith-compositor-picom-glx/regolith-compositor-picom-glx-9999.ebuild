...
DESCRIPTION="GLX backend Picom configuration for Regolith "
HOMEPAGE="https://github.com/regolith-linux/regolith-compositor-picom-glx"
SLOT="0"
LICENSE="GPL-3"
...
RDEPEND="x11-misc/picom"

src_install() {
	insinto /usr/share/regolith-compositor
	doins init
	insinto /etc/regolith/picom
	doins config
}
